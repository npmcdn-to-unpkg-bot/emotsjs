...
window.all = _index.all;
window.random = _index.random;
window.parse = _index.parse;
window.get = _index.get;
window.Dom = _index.Dom;
...
var _emots = require('./emots.json');

var _emots2 = _interopRequireDefault(_emots);
...
function all() {
	...
	var all = Object.keys(_emots2.default);
	return all.map(function (item) {
		return _emots2.default[item];
	});
}
...
function get(emot) {
	return _emots2.default[emot] ? _emots2.default[emot] : getRandomItem();
}
...
},{"./emots.json":4,"emojione":1,"unique-random-array":2}]},{},[5]);
